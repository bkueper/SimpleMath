...
public class UserSelection extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageButton.setOnClickListener(v -> openCreateUser());
    ...
    public void addUser(String name) {
        ...
        tempButton.setOnLongClickListener(v -> {
            ...
            tempButton.setOnClickListener(v1 -> closeEditUsernameMenu(editButton));
